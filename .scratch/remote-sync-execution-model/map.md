...
- **Todoist parity.** Whether Todoist adopts the same scope interface and backoff as craft. Cheap today at 4 calls and 1.6 s, so there is no pressure on it — Drive's half of this question has graduated into its own ticket.
